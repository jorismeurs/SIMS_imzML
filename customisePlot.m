classdef customisePlot
    % Customising heat maps
    %
    % CIVIDIS colormap downloaded from: https://uk.mathworks.com/matlabcentral/fileexchange/66493-alexhenderson-cividis
    ...
    methods
        function obj = setCMAP(obj)
            if isequal(obj.CMAPval,'hot')
                obj.CMAP = hot();
